...
func NewResourceCodecs(ctx context.Context, logger logger.Logger) *ResourceCodecs {
...
// Determine will determine video and audio stream codecs of target resource
func (d *ResourceCodecs) Determine(
